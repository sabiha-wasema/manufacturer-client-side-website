...
const ToolDetail = () => {
    ...
    return (
        <div>
            <div className='hero min-h-screen bg-base-100 lg:px-12  sm:mt-9 '>
                <div className="hero-content flex-col lg:flex-row px-20 sm:p-4">
                    <div className='flex-shrink-0 mr-10 pl-7'>
