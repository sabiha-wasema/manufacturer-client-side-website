        ...
        <div class="drawer drawer-end">
            ...
            <div class="drawer-content flex flex-col">
                ...
                <div class="w-full navbar top-0 fixed z-50 lg:px-16 bg-base-100">
                    ...
                    <div onClick={navigateToAdminHome} class="flex-1 px-2 mx-2 text-2xl font-bold text-yellow-500"><span className='text-rose-600 text-3xl'>Brush</span>Waremag</div>
